...
describe('camera path', () => {
  it('interpolates targets and holds through long gaps', () => {
    const pts = [
      { t: 0, x: 0.2, y: 0.5, h: 0.2 },
      { t: 1, x: 0.4, y: 0.5, h: 0.2 },
      { t: 5, x: 0.8, y: 0.5, h: 0.2 },
    ];
  ...
  it('ignores jitter inside the deadzone', () => {
    const pts = Array.from({ length: 50 }, (_, i) => ({ t: i * 0.2, x: 0.5 + (i % 2 ? 0.01 : -0.01), y: 0.5, h: 0.2 }));
  ...
  it('moves smoothly to a new position and settles there', () => {
    const pts = [
      { t: 0, x: 0.3, y: 0.5, h: 0.2 },
      { t: 2, x: 0.3, y: 0.5, h: 0.2 },
      { t: 2.2, x: 0.7, y: 0.5, h: 0.2 },
      { t: 8, x: 0.7, y: 0.5, h: 0.2 },
    ];
  ...
  it('cuts instead of panning at a scene cut', () => {
    const pts = [
      { t: 0, x: 0.2, y: 0.5, h: 0.2 },
      { t: 3, x: 0.2, y: 0.5, h: 0.2 },
      { t: 3.01, x: 0.8, y: 0.5, h: 0.2 },
      { t: 6, x: 0.8, y: 0.5, h: 0.2 },
    ];
